        ...
        <>
            <div className="mt-[3px] pb-4 px-2">
                ...
                <div className="flex items-center gap-1 py-1 mt-[16px]">
                    <p className="text-[12px] font-bold text-gray-400">Withdraw Address (SOL only)</p>
                </div>
                <div className="bg-[#0F0F0F] border  border-[#7A7A7A] flex w-full h-[38px]  gap-1  rounded-[12px] items-center mt-[8px]">
                ...
                <div className="bg-gradient-to-r from-[#28A7CF] to-[#9283EE] py-3  flex w-full h-[38px]  gap-1  rounded-[12px] items-center mt-[8px]">
                    <div className="w-full px-1 text-center justify-center  text-white">
                      Withdraw
                    </div>
                </div>
