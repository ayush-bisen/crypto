      ...
      >
        <div className='flex justify-center relative z-10'>
          <div className='mt-[105px]  '>
            <p className="w-[1248px] font-bold text-center">
              ...
              <br />
              <span className="w-[1248px] text-[82px] font-bold text-center text-white">Blockbit </span>
        ...
        <div className="flex justify-center relative z-10">
          <div className="relative inline-block mt-[36px] p-[3px] rounded-[48px] bg-gradient-to-r from-[#1E90FF] to-[#0000CD] hover:bg-radial-gradient hover:from-[#2593F9] hover:to-[#155B9B]">
            <button onClick={onClickWalletConnect} className="flex items-center justify-center  px-[48px] py-[16px] rounded-[48px] text-white text-[20px] font-bold bg-[#171717] w-full h-full hover:bg-gradient-to-r hover:from-[#1E90FF] hover:to-[#155B9B] hover:text-[#FFFF]">
              <Image alt="Launch Icon" loading="lazy" width="32" height="32" decoding="async" data-nimg="1" src={ADSS} className="hover:brightness-125" />
        ...
        >
          <Image
            src={InstagramCheckMarK} height={20} width={20} alt="Launch Icon"
          />
        ...
        <div className='flex justify-center mt-[29px] relative z-10'>
          <Image src={IMAGE_Main} alt="img" layout="responsive"
        ...
        <div
          ...
          style={{ backgroundImage: `url('/assets/images/Lamp.svg')`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat' }}
        >

          <div
            className="self-stretch flex-grow-0 flex-shrink-0 w-[0.1px] bg-gray-600  h-[500px] mt-20"
          />
          <div className="flex flex-col justify-center items-start w-[402px] relative gap-8">
            ...
            <div className="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 relative gap-4">
              <div
                ...
                style={{ background: "linear-gradient(to bottom, #2593f9 18.6%, #00ffd1 100%)" }}
              />
            ...
            <div className="relative group flex justify-center items-center flex-grow-0 flex-shrink-0 h-[62px] gap-2 pl-9 pr-7 py-6 rounded-[42px] transition-all duration-300 ease-in-out">
              ...
              <Image src={IMAGE_TABLE} width={20} height={20} alt="GRW" className="z-10" />
        ...
        <div className="md:px-[80px] gap-10 flex flex-col lg:flex-row justify-between px-[20px] md:px-[50px] lg:px-[169px] items-center mt-[100px] md:mt-[100px] lg:mt-[200px] relative z-10 bg-cover bg-center"
        ...
        >
          ...
          <div className="flex flex-col justify-center items-start w-[402px] relative gap-8">
            <div
              className="absolute self-stretch flex-grow-0 flex-shrink-0 w-[0.1px] bg-gray-600  h-[500px] mt-20"
        ...
        Start Trading Today For Free
        <div className="md:px-[80px] flex flex-col lg:flex-row justify-between px-[20px] md:px-[50px] lg:px-[169px] items-center mt-[100px] md:mt-[100px] lg:mt-[200px] relative z-10 bg-cover bg-center"
          style={{ backgroundImage: `url('./assets/images/Lamp.svg')` }}
        >
          <div
            className="self-stretch flex-grow-0 flex-shrink-0 w-[0.1px] bg-gray-600  h-[500px] mt-20"
