...
const Spinner = () => {
  ...
  //Commenting out for testing purpuse - Dummy
  // const wallet = useWallet();
  // const publicKey = wallet.publicKey?.toString();
  const publicKey = "lklkvlnlnvndjnawadijfjlk";
      ...
      {publicKey ? (
        <>
          <div className="flex flex-col items-center mx-auto mt-10">
            <div className="max-w-[620px] w-full bg-[#141414] rounded-[16px] p-4">
            ...
            <div className="max-w-[620px] w-full  rounded-lg mt-1">
              {/* Dynamic Navbar */}
              <div className="flex  bg-[#141414] rounded-[16px] p-1 items-center justify-center gap-4 w-full mb-1">
                <div
                  className={`w-full lg:w-[48%] flex justify-center items-center gap-1 cursor-pointer py-2 rounded-[16px] ${
                    dynamicCategory === "buy"
              ...
              {dynamicCategory === "buy" && (
                <div className="w-full bg-[#141414] p-4 rounded-[16px] flex flex-col gap-2 mb-1 xl:hidden">
                  <div className="flex flex-row justify-between text-center">
                    <div className="flex gap-1">
                      <Image
                        ...
                        alt="ddd"
                      />
                      <span className="text-[14px] sm:text-[18px] font-bold text-white text-start md:text-left">
                        What is SL/TP?
                      </span>
                    </div>
              ...
              <div className="relative max-w-[620px]  w-full mx-auto">
                ...
                <div className="max-w-[300px] w-full absolute right-[-302px] top-[-62px] hidden xl:block">
                  {" "}
                  {/* Set the child to absolute and right */}
                  {dynamicCategory === "buy" && (
                    <div
                      className="bg-[#2593F90D] backdrop-filter: blur(40px)
 p-4 rounded-lg flex flex-col gap-5"
                    >
                      ...
                      <p className="text-[#858686] text-[14px] md:text-[16px] font-medium leading-6 md:leading-8">
                        The Auto Buy functionality is configured to determine
                        the precise conditions under which tokens from the
                        Pending Pool are purchased. Once the specified criteria
                        are fulfilled, the bot will automatically execute the
                        purchase, and the token will be reflected in the open
                        positions.
                      </p>
                    </div>
                  )}
                  {dynamicCategory === "sl_tp" && (
                    <div className="bg-[#2593f9]/5 p-4 backdrop-blur-2xl rounded-lg flex flex-col gap-5">
                      ...
                      <p className="text-[#858686] text-[14px] md:text-[16px] font-medium leading-6 md:leading-8">
                        TP/SL, which stands for Take Profit and Stop Loss,
                        enables you to establish predefined thresholds for
                        realizing profits or limiting losses on your open
                        positions.
                      </p>
                    </div>
                  )}
              ...
              <div className="bg-[#141414] rounded-[16px]">
                {dynamicCategory === "buy" && (
                  <TabAutoBuy
                    setting={settingInfo}
                ...
                <div className="flex flex-row w-full gap-2 mt-1 p-2">
                  ...
                  <button
                    ...
                    className="flex-1 bg-[#202020] hover:bg-[#2c2c2c] border border-[#7A7A7A] rounded-[16px] px-4 py-2 text-white text-base font-bold"
                  >
                    Cancel
                  </button>
                </div>
